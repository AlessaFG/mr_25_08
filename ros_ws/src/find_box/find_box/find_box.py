...
"""
Libreria per l'ascolto delle posizioni delle box.
"""
...
def main():
    ...
    # Salvataggio log di navigazione per il plot
    ...
    while rclpy.ok():
        try:
            ...
            if target_id not in listener_node.available_boxes:
                ...
                continue
            # Posizione della box e del robot
            ...
            # Calcolo del target tenendo conto della distanza di stop
            stop_distance = 1.20 
